...
async function fetchLimits() {
  ...
  try {
    ...
    const response = await axios.get(`${API_URL}/limits/trainer-overview?view=geschaeftsstelle`)
    ...
    <div class="d-flex justify-space-between align-center mb-4">
      <div>
        ...
        <div class="text-subtitle-1 text-medium-emphasis">
          Auslastung aller Übungsleiter in allen Abteilungen.
        </div>
      </div>
    </div>
              ...
              <td>
                <div class="progress-bar">
                  <div
                      ...
                      :class="{ 'progress--critical': getProgressPercentage(item.usedAmount, item.limit) >= 100 }"
                  />
                </div>
